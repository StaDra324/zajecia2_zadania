...
Top25Words <- frequent_terms$WORD[1:min(25, nrow(frequent_terms))]
Top100Words <- frequent_terms$WORD[1:min(100, nrow(frequent_terms))]
Top200Words <- frequent_terms$WORD[1:min(200, nrow(frequent_terms))]
...
# Aktualizacja listy stopwords na podstawie nowego tekstu
Top25Words <- frequent_terms$WORD[1:min(25, nrow(frequent_terms))]
Top100Words <- frequent_terms$WORD[1:min(100, nrow(frequent_terms))]
Top200Words <- frequent_terms$WORD[1:min(200, nrow(frequent_terms))]
